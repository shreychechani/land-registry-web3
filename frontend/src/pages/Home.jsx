...
export default function Home({ setPage }) {
  const stats = [
    { label: 'Lands Registered', value: '—', icon: '🏠' },
    { label: 'Transactions', value: '—', icon: '🔄' },
    { label: 'Verified Today', value: '—', icon: '✅' },
    { label: 'Active Disputes', value: '—', icon: '⚖️' },
  ];
    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <div className="fade-up" style={{ textAlign: 'center', marginBottom: 64 }}>
        <div style={{
          ...
          POWERED BY POLYGON BLOCKCHAIN · IBM WATSON
        </div>
        <h1 style={{
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: 'var(--text2)', marginBottom: 32 }}>
          Six modules covering the complete lifecycle of land ownership.
        </p>
        <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--blue)', marginBottom: 4, letterSpacing: 1 }}>
            INSPIRED BY REAL WORLD PROJECT
          </div>
          <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 6 }}>
            IBM & Ghana Government — Blockchain Land Registry (2019)
          </div>
          <div style={{ fontSize: 13, color: 'var(--text2)' }}>
            IBM partnered with Ghana's Ministry of Lands to replace paper-based land records with an
            immutable blockchain system — increasing transparency, reducing fraud, and enabling instant verification.
          </div>
        </div>
      </div>
    </div>
